    ...
    <>
      ...
      >
        <button
          ...
          className="btn-glow w-full flex items-center justify-center gap-2 rounded-2xl bg-primary px-6 py-4 text-lg font-bold text-primary-foreground max-w-md mx-auto"
        >
